...
begin
  ...
  begin
    ...
    qViznatiVinnim.SQL.Text:='insert into VIZNATIVINNIM (KODPOLY) values (gen_id(GET_DICTIONARIES_RECORD_ID,1))';
    qViznatiVinnim.Open;
    qViznatiVinnim.SQL.Clear;
    qViznatiVinnim.SQL.Text:='select * from VIZNATIVINNIM order by KODPOLY';
    qViznatiVinnim.Open;
    qViznatiVinnim.Last;
    frmVizmatiVinnimEdit.edtKodPoly.Text:=IntToStr(qViznatiVinnim.FieldByName('KODPOLY').Value);
    frmVizmatiVinnim.DBRichEdit1.DataField:='VIZVINNIM';
  end;
end;
...
begin
  ...
  begin
    ...
    begin
      frmVizmatiVinnim.DBRichEdit1.DataField:='';
      frmVizmatiVinnim.qViznatiVinnim.SQL.Clear;
      frmVizmatiVinnim.qViznatiVinnim.SQL.Text:='delete from VIZNATIVINNIM where KODPOLY=:Kod';
      frmVizmatiVinnim.qViznatiVinnim.Params.Clear;
      frmVizmatiVinnim.qViznatiVinnim.Params.Add;
      frmVizmatiVinnim.qViznatiVinnim.Params[0].Name:='Kod';
      frmVizmatiVinnim.qViznatiVinnim.Params[0].Value:=frmVizmatiVinnimEdit.edtKodPoly.Text;
      frmVizmatiVinnim.qViznatiVinnim.Open;
  ...
  begin
    ...
    fs.Free;
    frmVizmatiVinnim.qViznatiVinnim.SQL.Clear;
    frmVizmatiVinnim.qViznatiVinnim.SQL.Text:='update VIZNATIVINNIM set ZMIST=:Zmist,VIZVINNIM=:fil where KODPOLY=:Kod';
    frmVizmatiVinnim.qViznatiVinnim.Params.Clear;
    frmVizmatiVinnim.qViznatiVinnim.Params.Add;
    frmVizmatiVinnim.qViznatiVinnim.Params[0].Name:='Zmist';
    frmVizmatiVinnim.qViznatiVinnim.Params[0].Value:=frmVizmatiVinnimEdit.edtZmist.Text;;
    frmVizmatiVinnim.qViznatiVinnim.Params.Add;
    frmVizmatiVinnim.qViznatiVinnim.Params[1].LoadFromFile(temp+'\file.tmp',ftMemo);
    frmVizmatiVinnim.qViznatiVinnim.Params[1].Name:='fil';
    frmVizmatiVinnim.qViznatiVinnim.Params.Add;
    frmVizmatiVinnim.qViznatiVinnim.Params[2].Name:='Kod';
    frmVizmatiVinnim.qViznatiVinnim.Params[2].Value:=frmVizmatiVinnimEdit.edtKodPoly.Text;
    frmVizmatiVinnim.qViznatiVinnim.Open;
    frmMain.trAzz.CommitRetaining;
