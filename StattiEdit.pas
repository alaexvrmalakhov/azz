...
begin
{
  ...
  begin
    ...
    begin
      qStatti.SQL.Clear;
      qStatti.SQL.Text:='insert into STATTI (KODSTATTI) values (gen_id(GET_DICTIONARIES_RECORD_ID,1))';
      qStatti.Open;
      qStatti.SQL.Clear;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        frmStatti.qStatti.SQL.Text:='delete from NORMATIVI where KODSTATTI=:Kod';
